    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            ...
            <div class="card-toolbar">
                <!--begin::Button-->
                <button type="button" class="btn btn-success font-weight-bolder mr-2" data-toggle="modal" data-target="#tambah">
    ...
    <div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <?php echo form_open_multipart('tambahpanitia/insertData') ?>
                <!--begin::Form-->
                <form class="form-group">
                    <div class="modal-body">
                        <div class="card-body">
                            <div class="mb-3">
                                <label>Nama</label>
                                <input type="text" class="form-control" name="nama_panitia" required />
                                <label>Email</label>
                                <input type="email" class="form-control" name="email" required />
                                <label>No.Telepon</label>
                                <input type="text" class="form-control" name="telepon_panitia" required />
        ...
        <div class="modal fade" id="edit<?= $value['id_panitia'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('tambahpanitia/editData/' . $value['id_panitia']) ?>
                    <!--begin::Form-->
                    <form class="form-group">
                        <div class="modal-body">
                            <div class="card-body">
                                <div class="mb-3">
                                    <label>Nama</label>
                                    <input type="text" value="<?= $value['nama_panitia'] ?>" class="form-control" name="nama_panitia" required />
                                    <label>Email</label>
                                    <input type="email" value="<?= $value['email'] ?>" class="form-control" name="email" required />
                                    <label>No.Telepon</label>
                                    <input type="text" value="<?= $value['telepon_panitia'] ?>" class="form-control" name="telepon_panitia" required />
                                    <label>Password</label>
                                    <input type="text" value="<?= $value['password'] ?>" class="form-control" name="password" required />
                                    <label>Ganti Foto</label>
                                    <input type="file" class="form-control" name="foto" accept="image/*" />
                                    <img src="<?= base_url('foto/' . $value['foto']) ?>" width="100px" height="100px" class="pt-10">
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
        ...
        <div class="modal fade" id="delete<?= $value['id_panitia'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary font-weight-bold" data-dismiss="modal">Batal</button>
                        <a class="btn btn-danger font-weight-bold" href="<?= base_url('tambahpanitia/deleteData/' . $value['id_panitia']) ?>">Hapus</a>
                    </div>
                    <!--end::Form-->
