    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            ...
            <div class="card-toolbar">
                <!--begin::Button-->
                <button type="button" class="btn btn-success font-weight-bolder mr-2" data-toggle="modal" data-target="#tambah_pekerjaan">
    ...
    <div class="modal fade" id="tambah_pekerjaan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <?php echo form_open('managepekerjaan/insertData') ?>
                <!--begin::Form-->
        ...
        <div class="modal fade" id="edit<?= $value['id_pekerjaan'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <?php echo form_open('managepekerjaan/editData/' . $value['id_pekerjaan']) ?>
                    <!--begin::Form-->
                    <form class="form-group">
                        <div class="modal-body">
                            <div class="card-body">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-danger font-weight-bold" href="<?= base_url('managepekerjaan/deleteData/' . $value['id_pekerjaan']) ?>">Hapus</a>
                    </div>
                    <!--end::Form-->
