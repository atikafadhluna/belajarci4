    ...
    <div class="card card-custom">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="mb-5">
                            <img src="<?= base_url('berkas/akte kelahiran/' . $siswa['akte_kelahiran']) ?>" width="250px" height="250px" id="gambar_load">
                        </div>
                    </div>
                    <div class="col-lg-6 mb-3">
        ...
        <?php if (isset($cs['status_pendaftaran'])) { ?>
            <div class="card-footer">
                <div class="row">
                    <button type="submit" class="btn btn-primary btn-shadow-hover font-weight-bolder w-100 py-3">
                        Daftarkan Sekarang
                    </button>
                </div>
            </div>
